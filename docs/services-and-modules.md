...
4. **Brief's `unique_together(order_item, event_type, channel)` dedup is overridden by D17's dedupe_key** — followed D17; noting only because the original brief text still says otherwise.
